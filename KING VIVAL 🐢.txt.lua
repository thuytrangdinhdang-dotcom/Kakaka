...
local Window = Fluent:CreateWindow({Title = "KingVival Hub [Blox Fruit]",SubTitle = "| By ng nh em ",TabWidth = 155,Size = UDim2.fromOffset(555, 320),Acrylic = false,Theme = "Amethyst",MinimizeKey = Enum.KeyCode.End})
...
ToggleButton.Image = "rbxassetid://99311170973886"
...
Tabs.Misc:AddButton({Title = "Rain Fruits (Client)", Description = "",Callback = function()
  for i, v in pairs(game:GetObjects("rbxassetid://99311170973886")[1]:GetChildren()) do
