...
local function NotificacaoNightMystic(titulo, mensagem)
    local success = pcall(function()
        ...
        local LogoID
        UIStroke.Color = Color3.fromRGB(0, 255, 100 = "rbxassetid://89947810111304"
        local duration = 5
        ...
        Main.BackgroundColor3 = Color3.fromRGB(0, 255, 100)
        ...
        IconBg.BackgroundColor3 = Color3.fromRGB(0, 255, 100)
    ...
    if not success then
        warn("[Đang Yeu Em Hub] Erro ao exibir notificação")
    end
end
...
-- GỌI THỬ ĐỂ TEST:
-- ==========================================
NotificacaoNightMystic("Dang Yeu Em Notification 🔔", "New Update v4.0🔥")
task.wait(0.8)
NotificacaoNightMystic("Dang Yeu Em Thông Báo 🔔", "Cập Nhật Mới v4.0🔥")
...
local Window = redzlib:MakeWindow({
    Title = "Dang Yeu Em Hub (Premium) V5 [Beta]",
    SubTitle = "by KhDang",
    SaveFolder = true,
...
local MinimizeButton = Window:AddMinimizeButton({
    Button = { 
        Image = "rbxassetid://6031068430", -- Dùng ID ảnh bạn chọn
        BackgroundTransparency = 1,
        Name = "Dang Yeu Em_On_Top_V5.2.0.0.0.0.1" -- Đặt tên đúng yêu cầu
    },
...
Discord:AddDiscordInvite({
    Name = "Dang Yeu Em Script | Community✅",
    Description = "Cảm ơn vì đã sài script",
    Logo = "rbxassetid://6031068430",
    Invite = "No"
})
spawn(function()
    pcall(function()
