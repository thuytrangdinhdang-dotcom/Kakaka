local bypassKey = true
-- [Banana Hub By KhDang = vĩnh viễn]
--   Banana Hub by Khdang= vĩnh viễn KEY GATE
-- =======================
...
SG.Name="BananaHub_Gate"; SG.ResetOnSpawn=false
...
Ttl.BackgroundTransparency=1; Ttl.Text="BananaHub lấy 1 lần = vĩnh viễn"
...
Ft.BackgroundTransparency=1; Ft.Text="BananaHub 1 lần = vĩnh viễn  v3.1"
        ...
        task.delay(0.32,function()
            ...
            task.spawn(function()
                ...
                local function makeText(timeStr)
                    return "Thoi gian con lai: "..timeStr.." | Script by KhDang 1 lần = vĩnh viễn"
                end
