...
print("Khánh Đăng⚔️ | Code chính đã load!")

-- Dán code chính của bạn ở đây
--[[ 
    SYSTEM BY KHDANG BLOXFRUIT 
    LINK GET KEY: https://link4m.org/X3SuySR
    KEY: Panda Hub Kaitun
]]
...
local correctKey = "Panda Hub Kaitun"
...
CopyBtn.MouseButton1Click:Connect(function()
    if setclipboard then
        setclipboard("https://link4m.org/X3SuySR")
    end
